class Labels(object):
    def __init__(self,method_input):
        ...
        self.templatefnm = 'template_mouse2_badge.doc'
        ...
        self.STRtypes = ['neighborhood', 'coexpression', 'cooccurrence', 'databases', 'experiments', 'genefusion', 'textmining', 'black']
        self.STRtypes2 = ['neighborhood', 'coexpression', 'cooccurrence', 'databases', 'experiments', 'genefusion', 'textmining', 'complete', 'black']